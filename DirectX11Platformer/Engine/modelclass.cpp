...
void ModelClass::SetPositionX(float input)
{
	m_positionX = input;
}

void ModelClass::SetPositionY(float input)
{
	m_positionY = input;
}

void ModelClass::SetPositionZ(float input)
{
	m_positionZ = input;
}
...
{
	return float(m_positionX);
}

float ModelClass::GetPositionY()
{
	return float(m_positionY);
}

float ModelClass::GetPositionZ()
{
	return float(m_positionZ);
}

void ModelClass::SetScale(float input)
{
	m_scale = input;
}
